...
import { AssetDetail } from
  '@/components/asset/asset-detail';
import { AssetViewer } from
  '@/components/asset/asset-viewer';
import type { Asset } from '@/types/asset';

function SelectedAssetPanel(
  props: { asset: Asset; caseId: string },
): React.ReactElement {
  ...
  return (
    <div
      ...
      className="fixed inset-y-0 right-0 z-40 flex
        w-full max-w-2xl flex-col overflow-y-auto
